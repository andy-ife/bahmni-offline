...
public class DbService {
    ...
    public void deletePatientData(String uuid) {
        ...
        db.execSQL("DELETE FROM patient_attributes WHERE patientUuid = '" + uuid + "'");
        db.execSQL("DELETE FROM patient_address WHERE patientUuid = '" + uuid + "'");
        db.execSQL("DELETE FROM patient WHERE uuid = '" + uuid + "'");
